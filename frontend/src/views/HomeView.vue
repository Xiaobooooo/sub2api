<template>
  ...
  >
    ...
    <main class="relative">
      <section
        class="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:py-20"
      >
        <div class="flex flex-col justify-center">
          ...
          <h1
            class="mt-6 max-w-3xl text-4xl font-bold tracking-tight text-gray-950 dark:text-white sm:text-5xl lg:text-6xl"
          >
            {{ copy.hero.title }}
          </h1>
          <p
            class="mt-5 max-w-2xl text-base leading-8 text-gray-600 dark:text-dark-300 sm:text-lg whitespace-pre-line"
          >
              ...
              <div class="terminal-body">
                ...
                <div class="grid gap-2">
                  ...
                  <div
                    class="code-line"
                    :style="{
                      '--line-delay': `${terminalLines.length * 120}ms`,
                    }"
                  >
      ...
      <section
        class="bg-white/70 py-14 dark:border-dark-800 dark:bg-dark-900/40"
      >
          ...
          <div class="mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-5">
            ...
            >
              <div class="flex items-center gap-3">
                <div
                  class="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl bg-white p-2 shadow-sm ring-1 ring-gray-200 dark:bg-dark-800 dark:ring-dark-700"
                >
                  <img
                    v-if="tool.logo"
                    :src="tool.logo"
                ...
                <div class="min-w-0">
                  ...
                  <p
                    class="mt-1 text-xs font-medium text-gray-500 dark:text-dark-400"
                  >
                    {{ tool.meta }}
                  </p>
                </div>
              ...
              <p
                class="mt-4 text-sm leading-6 text-gray-600 dark:text-dark-300"
              >
                {{ tool.description }}
              </p>
            </article>
      ...
      <section class="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-16">
        <div class="lg:grid-cols-[0.75fr_1.25fr] lg:items-start">
          ...
          <article
            class="card card-hover mx-auto mt-8 max-w-3xl overflow-hidden p-6 md:p-8"
          >
            <div
            ...
            >
              <div class="flex items-start gap-4">
                <div
                  class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-primary-50 text-primary-600 ring-1 ring-primary-100 dark:bg-primary-900/25 dark:text-primary-300 dark:ring-primary-800/60"
                >
                  <Icon name="bolt" size="lg" />
                </div>
                <div>
                  <div class="badge badge-primary">
                    {{ copy.pricing.card.badge }}
                  </div>
                  <h3
                    class="mt-3 text-2xl font-bold tracking-tight text-gray-950 dark:text-white"
                  >
                    {{ copy.pricing.card.title }}
                  </h3>
              ...
              <router-link
                to="/pricing"
                class="btn btn-primary btn-md flex-shrink-0"
              >
                {{ copy.pricing.action }}
                <Icon name="arrowRight" size="sm" />
              </router-link>
      ...
      <section
        class="bg-white/70 py-14 dark:border-dark-800 dark:bg-dark-900/40"
      >
        <div class="mx-auto max-w-7xl grid gap-10 px-4 sm:px-6 lg:px-8">
          <div>
            <p
              class="text-sm font-semibold text-primary-600 dark:text-primary-400"
            >
          ...
          <div class="grid gap-4 md:grid-cols-2">
            ...
            >
              <div class="flex items-start gap-4">
                <div
                  class="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl bg-primary-50 text-primary-600 ring-1 ring-primary-100 dark:bg-primary-900/25 dark:text-primary-300 dark:ring-primary-800/60"
                >
      ...
      <section class="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8 lg:py-16">
        <div
          class="overflow-hidden rounded-2xl bg-gradient-primary p-8 text-white shadow-glow-lg md:p-10"
        >
...
const homeCopy = {
  zh: {
    ...
    ecosystem: {
      ...
      description:
        "面向日常编码、重构、调试和自动化任务，保持常见 AI Agent 的原有使用方式，只替换 API Key 与调用地址即可接入。",
      items: [
        {
          name: "Codex",
          meta: "OpenAI",
        ...
        },
        {
          ...
          logo: openClawLogo,
          description:
            "面向本地工作流的开源 AI Agent，适合可控的桌面开发环境。",
        },
        {
          name: "Hermes",
          meta: "AI Agent",
    ...
    benefits: {
      ...
      title: "一个入口覆盖更多模型与场景",
      description:
        "围绕真实开发工作流设计，减少环境、账号和工具切换带来的额外成本。",
      items: [
        {
          icon: "key",
          title: "一个 Key 调用全模型",
    ...
    cta: {
      title: "点击开始接入AI大模型",
      description: "进入控制台创建 API Key ，即可调用全球主流AI大模型。",
      action: "开始配置",
    },
  },
  en: {
    ...
    hero: {
      ...
      description:
        "Direct access without VPN, no account-ban risk, non-expiring balance\nlow-latency calls to mainstream models like Claude and ChatGPT.",
      start: "Get started",
      dashboard: "Dashboard",
      pricing: "View models",
      stats: [
    ...
    ecosystem: {
      ...
      description:
        "Keep your familiar coding, refactoring, debugging, and automation workflow. Replace the API key and base URL to connect through the gateway.",
      items: [
        {
          name: "Codex",
          meta: "OpenAI",
          logo: codexLogo,
          description:
            "Built for large refactors, bug fixes, test generation, and code review tasks.",
        },
        {
          name: "Claude Code",
          meta: "Anthropic",
          logo: claudeCodeLogo,
          description:
            "Keeps the CLI assistant workflow for long-context analysis and project changes.",
        },
        {
          name: "OpenClaw",
          ...
          logo: openClawLogo,
          description:
            "A local open-source agent option for controlled desktop development.",
        },
        {
          name: "Hermes",
          meta: "AI Agent",
          logo: hermesLogo,
          description:
            "Connect automated agent flows to model capabilities for ongoing development tasks.",
        },
        {
          ...
          logo: "",
          description:
            "Use compatible endpoints with more editor plugins, terminal tools, and custom agents.",
        },
      ],
    },
    benefits: {
      ...
      description:
        "Designed around real development workflows to reduce environment, account, and tool switching overhead.",
      items: [
        {
          icon: "key",
          title: "One key for every model",
          description:
            "Manage one API key and switch between Claude, OpenAI, and other model families.",
        },
        {
          icon: "globe",
          title: "Low-latency direct access",
          description:
            "Optimized access reduces extra network setup and gets tools ready faster.",
        },
        {
          icon: "swap",
          title: "Change one BASE_URL",
          description:
            "Compatible with common SDK and Agent configuration patterns to lower migration cost.",
        },
        {
          icon: "chartBar",
          title: "Unified dashboard",
          description:
            "Track usage, balance, and key status from one place for individuals and teams.",
        },
      ],
    },
    pricing: {
      ...
      title: "PAYGO billing",
      description:
        "No subscription required. Pay only for what you use, with balance kept long term.",
      action: "View full pricing",
      card: {
        badge: "PAYGO",
        title: "Pay as you go, billed flexibly",
        description:
          "Create an API key and start calling models. Billing follows actual usage, without fixed plans or long-term quota estimates.",
        features: [
          {
            icon: "bolt",
            title: "Pay as you go",
            description:
              "Costs follow real requests and model usage, from trials to high-frequency workloads.",
          },
          {
            icon: "swap",
            title: "Flexible billing",
            description:
              "Use the same balance across different models and tools as your tasks change.",
          },
          {
            icon: "clock",
            title: "Balance never expires",
            description:
              "Top-up balance stays available long term, even for occasional usage.",
          },
          {
            icon: "chartBar",
            title: "Clear usage",
            description:
              "Track balance and request history from the dashboard.",
          },
        ],
      },
    },
    cta: {
      ...
      description:
        "Create an API key in the dashboard, then call Claude or OpenAI models.",
      action: "Start setup",
    },
  },
} as const;
